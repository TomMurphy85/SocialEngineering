...
$query = readFromDatabase("userName", "Users", "username = '$User'");
...
$Emailquery = readFromDatabase("userEmail", "Users", "userEmail = '$checkEmail'");
$numRowsEmail = mysqli_num_rows($Emailquery);

		  if (empty(trim($_POST["Email"]))) {
		    $email_err = "Email is required";
		} elseif($numRowsEmail > 0){
